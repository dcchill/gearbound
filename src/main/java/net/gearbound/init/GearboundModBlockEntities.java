...
public class GearboundModBlockEntities {
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> BROWN_BRASS_BACKPACK = register("brown_brass_backpack", GearboundModBlocks.BROWN_BRASS_BACKPACK,
			(pos, state) -> new BrownBrassBackpackBlockEntity(BROWN_BRASS_BACKPACK.get(), pos, state));
