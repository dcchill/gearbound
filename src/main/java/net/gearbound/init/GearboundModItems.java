...
public class GearboundModItems {
	...
	public static final DeferredItem<Item> LIGHT_GRAY_BRASS_BACKPACK_ITEM = REGISTRY.register("light_gray_brass_backpack_item",
			() -> new BrownBrassBackpackItemItem(GearboundModBlocks.LIGHT_GRAY_BRASS_BACKPACK, "Light Gray Brass Backpack"));
	...
	public static final DeferredItem<Item> LIGHT_BLUE_BRASS_BACKPACK_ITEM = REGISTRY.register("light_blue_brass_backpack_item",
			() -> new BrownBrassBackpackItemItem(GearboundModBlocks.LIGHT_BLUE_BRASS_BACKPACK, "Light Blue Brass Backpack"));
