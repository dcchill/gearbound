...
public class GearboundModItems {
	...
	public static final DeferredItem<Item> BROWN_BRASS_BACKPACK_ITEM = REGISTRY.register("brown_brass_backpack_item", () -> new BrownBrassBackpackItemItem(GearboundModBlocks.BROWN_BRASS_BACKPACK, "Brown Brass Backpack"));
